...
PDB_IN = "C8C10C12_221.pdb"
XTC_IN = "C8C10C12_221_skip.xtc"     # your file name
OUT_DIR = Path(".")
...
def main():
    ...
    multiframe_pdb = OUT_DIR / "C8C10C12_221_multiframe.pdb"
    metrics_json = OUT_DIR / "C8C10C12_221_metrics.json"
